@echo off
REM test_all_pdfs.bat - Test all 8 legal PDFs with simple_rag.py (Windows)
REM
REM Usage:
REM   test_all_pdfs.bat              Run tests and display output
REM   test_all_pdfs.bat > results.txt   Save output to file
